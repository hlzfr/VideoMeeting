...
public class DateTimePickDialogUtil implements DatePicker.OnDateChangedListener,
    ...
    public DateTimePickDialogUtil(Context context, long initDateTime) {
        this.context = context;
        this.initDateTime = long2StringTime(initDateTime);
    }

    public static String long2StringTime(long initDateTime) {
    ...
    public AlertDialog show() {
        LinearLayout dateTimeLayout = (LinearLayout) (View.inflate(context, R.layout.common_datetime, null));
...
//                        inputDate.setText(dateTime);
                            if (onClickListener != null) {
                                onClickListener.onOkListener(date);
                            }
                        }
                    })
...
//                        inputDate.setText("");
    ...
    public DateTimePickDialogUtil setOnClickListener(OnClickListener listener) {
