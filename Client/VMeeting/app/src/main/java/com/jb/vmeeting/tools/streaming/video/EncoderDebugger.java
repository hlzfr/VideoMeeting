...
import com.jb.vmeeting.tools.streaming.video.CodecManager.Codec;
...
public class EncoderDebugger{
    ...
    private void debug() {
        ...
        L.e("No usable encoder were found on the phone for resolution "
                + mWidth + "x" + mHeight);
        throw new RuntimeException(
